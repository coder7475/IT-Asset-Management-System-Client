...
const Hero = () => {
  return (
    <section className="hero md:min-h-screen relative">
      <div className="hero-bg md:absolute top-40 left-20  w-full md:block  md:w-[50%] lg:w-[40%] rounded p-5 space-y-3">
        <h1 className="md:text-5xl font-bold">AssetIT</h1>
        <h2 className="text-xl md:text-3xl font-medium">
          Powerful and Intuitive IT Asset Management Software
        </h2>
        <p className="para md:text-xl">
